...
public class Time {
    ...
    public static String formatTime(Long time) {
        ...
        String second = "";
        if (days > 0) {
            day = String.format("%2d gün, ", days);
        }
        if (hours > 0) {
            hour = String.format("%2d saat, ", hours);
        }
        if (minutes > 0) {
            minute = String.format("%2d dakika, ", minutes);
        }
        if (seconds > 0) {
            second = String.format("%2d saniye", seconds);
        }
