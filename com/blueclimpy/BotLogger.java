...
public class BotLogger {
    ...
    public static Logger startLogger = Logger.getLogger(BotMain.class.getName());
    public static Logger errorLogger = Logger.getLogger("Error");
    public static Logger commandLogger = Logger.getLogger("command");

    public static String LogError = "LogError.txt";
    public static String LogCommand = "LogCommand.txt";
    public static String LogMain = "log.txt";
    /**
    ...
    public static String toHasteBin(String message) {
        try {
            ...
            BotLogger.errorLog(e, null, "Pasting to HasteBin", "Probably server side");
        }
        return null;
    }
    ...
    public static void handleExceptionLog(Exception ex, MessageReceivedEvent e, String hasteBinURL)
    {
        ...
        EmbedBuilder error = new EmbedBuilder().setAuthor(ex.getClass().getName(), hasteBinURL, "https://cdn.discordapp.com/attachments/490921055372967937/508652900604444682/blue-logo-flame-hi.png")
